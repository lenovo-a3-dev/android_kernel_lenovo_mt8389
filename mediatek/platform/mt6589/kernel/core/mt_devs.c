...
/*=======================================================================*/
/* IQS128 cap-sensor module                                              */
/*=======================================================================*/
#if defined(CONFIG_IQS128_CAPSENSOR)
static struct platform_device capsensorIQS128_device =
{
       .name        = "iqs_capsensor",
       .id          = -1,
};
...
/* begin, lenovo-sw zhaoxp3 add 2013-30-15, hall sensor support */
/*=======================================================================*/
/* hall sensor support                                            */
/*=======================================================================*/
...
#endif
/* end, lenovo-sw zhaoxp3 add 2013-30-15, hall sensor support */
...
#if defined(CONFIG_IQS128_CAPSENSOR)
        //pengli add
        retval = platform_device_register(&capsensorIQS128_device);
        if(retval != 0) {
             return retval;
        }
#endif
...
#endif
/* end, lenovo-sw zhaoxp3 add 2013-03-15, hall sensor support */
