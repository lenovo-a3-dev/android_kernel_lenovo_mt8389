...
status_t AudioResourceManager::SelectOutputDevice(uint32_t new_device)
{
    ...
    //if (new_device == mDlOutputDevice && new_device != AUDIO_DEVICE_OUT_WIRED_HEADSET && new_device != AUDIO_DEVICE_OUT_WIRED_HEADPHONE) return NO_ERROR;
    //if ((new_device == AUDIO_DEVICE_OUT_WIRED_HEADSET && mDlOutputDevice == AUDIO_DEVICE_OUT_WIRED_HEADPHONE) || (new_device == AUDIO_DEVICE_OUT_WIRED_HEADPHONE && mDlOutputDevice == AUDIO_DEVICE_OUT_WIRED_HEADSET) || (new_device == mDlOutputDevice && new_device == AUDIO_DEVICE_OUT_WIRED_HEADSET) || (new_device == mDlOutputDevice && new_device == AUDIO_DEVICE_OUT_WIRED_HEADPHONE)) goto start_device;
    //if ((new_device == AUDIO_DEVICE_OUT_WIRED_HEADSET && mDlOutputDevice == AUDIO_DEVICE_OUT_WIRED_HEADPHONE) || (new_device == AUDIO_DEVICE_OUT_WIRED_HEADPHONE && mDlOutputDevice == AUDIO_DEVICE_OUT_WIRED_HEADSET)) goto start_device;
...
status_t AudioResourceManager::StartInputDevice()
{
    ...
    if (mUlInputDevice  == AUDIO_DEVICE_IN_COMMUNICATION) {
        ...
        mAudioAnalogInstance->AnalogSetMux(AudioAnalogType::DEVICE_IN_PREAMP_R, AudioAnalogType::MUX_IN_MIC3);
#else
#if defined(CUSTOM_MAIN_MIC_BOTTOM)
