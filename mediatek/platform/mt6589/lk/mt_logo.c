...
#ifdef A3000_COMMON
#if 0
#define TOP_ANIMATION_LEFT           (233) // top animation
#define TOP_ANIMATION_TOP            (635)
#define TOP_ANIMATION_RIGHT          (368)
#define TOP_ANIMATION_BOTTOM         (659)
#endif 
#define TOP_ANIMATION_LEFT           (218) // top animation
#define TOP_ANIMATION_TOP            (414)
#define TOP_ANIMATION_RIGHT          (381)
#define TOP_ANIMATION_BOTTOM         (753)
#endif 
...
//      DISP_PROG_BAR_DIRECT direct = DISP_VERTICAL_PROG_BAR;
	...
	DISP_PROG_BAR_DIRECT direct = DISP_VERTICAL_PROG_BAR;
        ...
        {
            show_logo(25+capacity_zero_index);
            if(++capacity_zero_index > 1)  capacity_zero_index = 0;
            mt_disp_update(0, 0, CFG_DISPLAY_WIDTH, CFG_DISPLAY_HEIGHT);	
            return;
        }
	else if (capacity < 100 && capacity > 20) 
        {
/*begin lenovo-sw xuwei9 2013-3-19 ,charging animation icon*/
#ifndef  ANIMATION_NEW
/*end lenovo-sw xuwei9 2013-3-19 ,charging animation icon*/
            show_logo(35);  // show background
            charging_animation_index++;
            printf("[ChargingAnimation]top_animation : left = %d, top = %d, right = %d, bottom = %d\n",  top_animation_rect.left, top_animation_rect.top,  top_animation_rect.right, top_animation_rect.bottom);
            show_animation(15 + charging_animation_index, top_animation_rect, top_animation_addr); // show top animation
	        ...
	        show_animation(18 + charging_animation_index, top_animation_rect, top_animation_addr); // show top animation

	    else if (capacity < 100)
                show_animation(21 + charging_animation_index, top_animation_rect, top_animation_addr); // show top animation
