#include <linux/spinlock.h> /*lenovo yangyu 20130407 add lock to solve multitask access prStaRecList problem*/
#include "precomp.h"
        ...
        case OP_MODE_ACCESS_POINT:
            {
                ...
                spin_lock(&prAdapter->StaRecList_Lock);/*lenovo yangyu 20130407 add lock to solve multitask access prStaRecList problem*/
                ...
                spin_unlock(&prAdapter->StaRecList_Lock);/*lenovo yangyu 20130407 add lock to solve multitask access prStaRecList problem*/
    ...
    do {
        ...
        *pu2StatusCode = STATUS_CODE_REQ_DECLINED;
        ...
        if (prP2pBssInfo->rStaRecOfClientList.u4NumElem > P2P_MAXIMUM_CLIENT_COUNT ||
            ...
            bssRemoveStaRecFromClientList(prAdapter, prP2pBssInfo, prStaRec);/*MTK patch fix KE due to do cnmStaRecFree but not bssRemoveStaRecFromClientList, so staRec is reused in cnmStaRecAlloc, leading to null point in link entry prev/next*/
