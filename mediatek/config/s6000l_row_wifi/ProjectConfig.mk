...
CUSTOM_HAL_IMGSENSOR = hi704_yuv
...
CUSTOM_KERNEL_IMGSENSOR = hi704_yuv
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LCM = bp101wx1_n
...
CUSTOM_LK_LCM = bp101wx1_n
CUSTOM_MODEM =
CUSTOM_PRELOADER_CUSTOM = custom
CUSTOM_SEC_AUTH_SUPPORT = no
CUSTOM_SEC_SIGNTOOL_SUPPORT = no
CUSTOM_UBOOT_LCM = bp101wx1_n
DEFAULT_INPUT_METHOD = com.adamrocker.android.input.simeji.OpenWnnSimeji
...
LENOVO_ONLY_FRONT_CAMERA = yes
LENOVO_HALL_SENSOR_SUPPORT = yes
LENOVO_BTKEYBOARD_COVER = yes
S6000_COMMON = yes
LENOVO_ENABLE_KPOC_SLEEP = yes
S6000L_ROW_COMMON = yes
LENOVO_BOOT_TIME_DELAY = yes
LENOVO_FEATURE_AGED_VERSION = no
LENOVO_COMBINE_CDROM_MTP_SOLUTION = no
