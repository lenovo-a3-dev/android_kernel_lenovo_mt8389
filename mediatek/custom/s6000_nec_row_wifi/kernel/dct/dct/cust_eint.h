...
#define CUST_EINT_EINT_HDMI_HPD_NUM              16
#define CUST_EINT_EINT_HDMI_HPD_DEBOUNCE_CN      3
#define CUST_EINT_EINT_HDMI_HPD_POLARITY         CUST_EINT_POLARITY_LOW
#define CUST_EINT_EINT_HDMI_HPD_SENSITIVE        CUST_EINT_EDGE_SENSITIVE
#define CUST_EINT_EINT_HDMI_HPD_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE

#define CUST_EINT_MHALL_NUM              162
