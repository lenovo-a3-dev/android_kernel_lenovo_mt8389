 ...
 ****************************************************************************/
/* SENSOR FULL SIZE */
#ifndef _HI542RAW_SENSOR_H
#define _HI542RAW_SENSOR_H
...
#define HI542_PV_PERIOD_PIXEL_NUMS   (2608)    // P mode's pixel # in one HSYNC w/o dummy pixels
#define HI542_PV_PERIOD_LINE_NUMS    (980)//(968)   // P mode's HSYNC # in one HSYNC w/o dummy lines

#define HI542_FULL_PERIOD_EXTRA_PIXEL_NUMS  62 //608 //450
#define HI542_FULL_PERIOD_EXTRA_LINE_NUMS 20 //56 //28
#define HI542_PV_PERIOD_EXTRA_PIXEL_NUMS 62 //450
#define HI542_PV_PERIOD_EXTRA_LINE_NUMS 20
