...
static s32 gtp_init_panel(struct i2c_client *client)
{
    ...
    case 0://AVC
	    memcpy(&config[GTP_ADDR_LENGTH], send_cfg_buf[2], cfg_len);
        break;
    case 2://O-flim
        memcpy(&config[GTP_ADDR_LENGTH], send_cfg_buf[0], cfg_len);
        break;
    case 3://Mutto
        memcpy(&config[GTP_ADDR_LENGTH], send_cfg_buf[1], cfg_len);
        break;
    default://default:O-film
        memcpy(&config[GTP_ADDR_LENGTH], send_cfg_buf[0], cfg_len);
    }
#if GTP_CUSTOM_CFG
